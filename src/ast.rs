...
pub enum NodeKind<'a> {
    ...
    Impl { decls: Option<NodeRef<'a>>, target: NodeRef<'a>, body: NodeRef<'a> },
    ImplTarget { idea: Option<NodeRef<'a>>, typ: NodeRef<'a> },
    Idea { relat: NodeRef<'a>, body: NodeRef<'a> },
    Enum { relat: NodeRef<'a>, body: NodeRef<'a> },
    Relat { child: NodeRef<'a>, parents: &'a [NodeRef<'a>] },
    Use { path: NodeRef<'a> },
